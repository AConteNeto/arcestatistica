...
<body class="landing">
	<div id="page-wrapper">
		...
		<header id="header">
			<nav id="nav">
				<ul>
					...
					<li>
						<a href="contact.php" class="scrolly">Contato</a>
					</li>
				</ul>
			</nav>
		</header>
		...
		<section id="one" class="spotlight style3 right">
			...
			<div class="content">
							...
							<p>
								...
								de forma a otimizar processos e reduzir o custo de funcionamento empresarial.
							</p>
			</div>
		...
		<!--<section id="three" class="spotlight style3 right">
			...
			<div class="content">
				<p>
					Quatro amigos, colegas de faculdade, que são apaixonados por analisar dados e acreditam que eles
